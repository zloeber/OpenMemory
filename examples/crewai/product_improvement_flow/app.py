...
def run_and_stream(module_name: str, requirements: str, target_path: str):
    ...
    thread = Thread(target=EngineeringFlow(module_name, requirements, target_path).kickoff)
    thread.start()
...
with gr.Blocks(theme=gr.themes.Ocean()) as demo:
    ...
    run_button.click(
        fn=run_and_stream, inputs=[module_name, requirements, target_path], outputs=chat
    )
