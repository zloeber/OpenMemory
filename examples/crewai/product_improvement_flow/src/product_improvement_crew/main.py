...
from product_improvement_crew.crews.engineering_crew.engineering_crew import (
    CodeReviewFeedback,
    EngineeringCrew,
)
...
class ProductImprovementState(BaseModel):
    module_name: str = ""
...
BUSINESS_REQUIREMENTS: list[ProductImprovementState] = [
    ProductImprovementState(
        module_name="openmemory_fork",
        business_requirement="Improve upon the existing project.",
        technical_design="Follow the existing design patterns and architecture found in AGENTS.md if they exist in the folder you are working on. If not, design a new architecture that is scalable and modular.",
        project_path="../../../",
        backend_code="backend",
        frontend_code="dashboard",
    )
]


class EngineeringFlow(Flow[ProductImprovementState]):
