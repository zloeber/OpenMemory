...
exports.bobResearchScenario = exports.aliceDevScenario = exports.BootstrapClient = void 0;
...
class BootstrapClient {
    ...
    async addMemory(namespace, memory, apiKey) {
        try {
            const payload = {
    ...
    async clearAgentMemories(namespace) {
        try {
...
exports.aliceDevScenario = aliceDevScenario;
// Scenario 2: Research Scientist
const bobResearchScenario = {
    agent: {
...
exports.bobResearchScenario = bobResearchScenario;
async function main() {
    console.log(`
╔════════════════════════════════════════════════════════════════════╗
