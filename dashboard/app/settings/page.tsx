...
const SETTING_METADATA: Record<string, SettingInfo> = {
    ...
    OM_VECTOR_BACKEND: {
        ...
        type: 'select',
        options: ['sqlite', 'qdrant', 'weaviate']
    },
    OM_VECTOR_TABLE: {
        category: 'Vectors',
    ...
    OM_QDRANT_API_KEY: {
        ...
        description: 'Authentication key for Qdrant (optional)',
        type: 'password'
    },
    OM_QDRANT_COLLECTION: {
        category: 'Vectors',
    ...
    OM_TIER: {
        ...
        description: 'HYBRID: Keyword+vector (recommended) | FAST: 256-dim synthetic (70-75% recall) | SMART: 384-dim hybrid (85% recall) | DEEP: 1536-dim full AI (95-100% recall)',
        type: 'select',
    ...
    OM_SUMMARY_MAX_LENGTH: {
        ...
        description: 'Maximum characters in memory summaries (default: 200)',
        type: 'number',
        placeholder: '200'
    },
    OM_SEG_SIZE: {
    ...
    OM_MCP_PROXY_ENABLED: {
        category: 'Server',
        label: 'MCP Proxy',
        description: 'Enable Model Context Protocol proxy service',
        type: 'select',
        options: ['true', 'false']
    },
    OM_PROXY_ONLY_MODE: {
        category: 'Server',
        label: 'Proxy-Only Mode',
        description: 'Disable standard API endpoints and only expose MCP proxy',
        type: 'select',
        options: ['true', 'false']
    },
    OM_LLM_CHAT_PROVIDER: {
        category: 'LLM',
        label: 'Chat LLM Provider',
        description: 'LLM provider for chat/reasoning features',
        type: 'select',
    ...
    OM_LLM_CHAT_MODEL: {
        category: 'LLM',
        label: 'Chat Model',
        description: 'Model name for chat/reasoning (e.g., llama3.2:latest, gpt-4)',
        type: 'text',
        placeholder: 'llama3.2:latest'
    },
    OM_LLM_CHAT_TEMPERATURE: {
        category: 'LLM',
    ...
    OM_DECAY_LAMBDA: {
        category: 'Memory',
        label: 'Decay Lambda',
        description: 'Decay rate for memory salience (exponential decay factor)',
        type: 'number',
        placeholder: '0.02'
    },
    OM_DECAY_INTERVAL_MINUTES: {
        ...
        description: 'Minutes between decay cycles (default: 1440 = 24 hours)',
        type: 'number',
        placeholder: '1440'
    },
    OM_DECAY_RATIO: {
        category: 'Memory',
        label: 'Decay Ratio',
        description: 'Ratio of memories to decay per cycle',
        type: 'number',
        placeholder: '0.03'
    },
    OM_DECAY_SLEEP_MS: {
        category: 'Memory',
        label: 'Decay Sleep (ms)',
        description: 'Delay between decay operations (ms)',
        type: 'number',
        placeholder: '200'
    },
    OM_IDE_MODE: {
    ...
    OM_IDE_ALLOWED_ORIGINS: {
        category: 'Features',
        label: 'IDE Allowed Origins',
        description: 'Comma-separated list of allowed CORS origins for IDE',
        type: 'text',
        placeholder: 'http://localhost:5173,http://localhost:3000'
    },
    OM_USER_SUMMARY_INTERVAL: {
        category: 'Memory',
        label: 'User Summary Interval (min)',
        description: 'Minutes between user summary updates',
        type: 'number',
        placeholder: '30'
    },
    OLLAMA_HOST: {
        category: 'API Keys',
        label: 'Ollama Host',
        description: 'Alternative Ollama host URL (fallback for OLLAMA_URL)',
        type: 'text',
        placeholder: 'http://localhost:11434'
    }
}
...
export default function settings() {
    ...
    const categoryIcons: Record<string, string> = {
        ...
        'LLM': 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z'
    }
