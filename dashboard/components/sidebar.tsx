...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    },
    {
      label: "Agents",
      path: "/agents",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15 21a6 6 0 0 0-12 0m12 0h6a2.25 2.25 0 0 0 2.25-2.25v-.75A2.25 2.25 0 0 0 21 15.75h-2.25m-3.75 5.25V19.5A5.25 5.25 0 0 0 9.75 14.25h0A5.25 5.25 0 0 0 4.5 19.5V21m9-10.5a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 0 0 0 7.5Zm6 4.5a3 3 0 1 0 0-6" /></svg>
    },
    {
      label: "Agent Memory",
      path: "/agent-memory",
